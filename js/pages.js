...
<section class="testimonials section" id="testimonials">
    <div class="container">
        ...
        <div class="review-video-grid">
            ${reviewVideos.map(v => `
            <div class="review-video-card fade-in">
        ...
        <div style="text-align:center;margin-top:32px;">
            <a href="${esc(BRAND.social.googlemaps)}" target="_blank" rel="noopener" class="btn-google-maps btn-ripple">
                ...
                اقرأ التقييمات الحقيقية على Google Maps
            </a>
        </div>` : ''}
    </div>
</section>
